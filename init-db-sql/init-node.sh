...
until MYSQL_PWD=${MASTER_MYSQL_ROOT_PASSWORD} mysql -u root -h master ; do
...
master_status_info=$(MYSQL_PWD=${MASTER_MYSQL_ROOT_PASSWORD} mysql -u root -h master -e "show master status\G")
